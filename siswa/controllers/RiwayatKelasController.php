...
use siswa\models\RiwayatKelasSearch;
...
/**
 * RiwayatKelasController implements the CRUD actions for SiswaRwKelas model.
 */
class RiwayatKelasController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $siswa_rw_kelas = SiswaRwKelas::find()->where(['id_siswa' => $siswa->id])->asArray()->all();
        $siswa_rw_kelas = array_column($siswa_rw_kelas, 'id');

        $searchModel = new RiwayatKelasSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        if ($siswa_rw_kelas) {
            $dataProvider->query->andFilterWhere(['id' => $siswa_rw_kelas]);
        } else {
