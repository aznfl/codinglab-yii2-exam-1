...
class WaliController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $waliSiswa = new SiswaWali();
        $id_user = Yii::$app->user->identity->id;
        $id_siswa = Siswa::find()->where(['id_user' => $id_user])->one()->id;

        $status_wali = ArrayHelper::map(RefStatusWali::find()->all(), 'id', 'status_wali');
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                ...
                $waliSiswa->id_siswa = $id_siswa;
                $waliSiswa->id_wali = $model->id;
                $waliSiswa->save();
