...
class MataPelajaranController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $mataPelajaran = GuruMataPelajaran::find()->where(['id_guru' => $guru->id])->asArray()->all();
        $mataPelajaran = array_column($mataPelajaran, 'id_mata_pelajaran');
    ...
    public function actionCreate()
    {
        ...
        $guruPelajaran = new GuruMataPelajaran();
        $id_user = Yii::$app->user->identity->id;
        $id_guru = Guru::find()->where(['id_user' => $id_user])->one()->id;
        ...
        if ($request->isAjax) {
            ...
            */
            ...
            if ($request->isGet) {
                ...
                $guruPelajaran->id_guru = $id_guru;
                $guruPelajaran->id_mata_pelajaran = $model->id;
                $guruPelajaran->save();
