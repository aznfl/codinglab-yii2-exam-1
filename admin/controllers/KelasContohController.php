...
use admin\models\KelasContohSearch;
...
/**
 * KelasContohController implements the CRUD actions for Kelas model.
 */
class KelasContohController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {    
        $searchModel = new KelasContohSearch();
